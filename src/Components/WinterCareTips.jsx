...
const WinterCareTips = () => {
    ...
    return (
       <div  className=' mt-10  '>
         ...
         <div className='flex justify-center itmes-center gap-25'>
            ...
            <div data-aos="fade-up-right" className='flex justify-center items-center'>
                    ...
                    <ol className='text-xl font-medium'>
                         <h2 className='text-3xl font-semibold  w-160 text-purple-600 mb-5'>Keep your furry friends safe, warm, and happy this winter with our expert tips.</h2>
